...
<body class="container">
        ...
        <div class="profile-header">
            ...
            <div class="profile-subtitle">
                ...
                <a href="https://wa.me/<?= $phoneClean ?>" target="_blank"
                   class="badge badge-whatsapp badge-pill">
        ...
        <div class="profile-body">
            ...
            <div class="action-buttons row mt-4 pt-3">
                <div class="col-md-6 mb-2 mb-md-0">
                   <button class="btn btn-group-details w-100" onclick="showGroup()">
                     <i class="bi bi-building"></i> عرض تفاصيل المجموعة
                   </button>
                </div>
                 <div class="col-md-6">
    ...
    <script>
        ...
        function showGroup() {
            ...
            fetch(`group_info.php?group=<?= urlencode($row['group'] ?? '') ?>`)
                .then(response => {
                    if (!response.ok) {
                        ...
                        <div class="text-center mb-3">
                            ...
                            ${groupPhoneClean ? `
                                <a href="https://wa.me/${groupPhoneClean}" target="_blank"
                                   ...
                                   <i class="bi bi-whatsapp"></i> تواصل مع رئيس الفوج
                                </a>` : ''
                            }
                        </div>
                        <hr class="my-3">`;
