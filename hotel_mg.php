...
$stmt = $pdo->query("select hotel_name, group_name, count(room_num) as rooms, start_date,end_date from res group by hotel_name,group_name, start_date,end_date order by end_date desc
");
...
<head>
    ...
    <title>تقرير حجزز التكتلات</title>
...
<body>
    ...
    <div class="container">
        <h2 class="text-center mb-4">تقرير حجز التكتلات</h2>
